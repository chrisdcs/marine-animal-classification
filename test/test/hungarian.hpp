...
public:
	...
	Hungarian();
	Hungarian(const vector<vector<double> >&, int, int, MODE);

	int init(const vector<vector<double> >& input_matrix, 
			   int rows, 
			   int cols, 
			   MODE mode);
	...
	const vector<vector<double> >& assignment() const;
...
protected:
	bool check_solution(const vector<double>& row_dec, const vector<double>& col_inc, const vector<double>& col_vertex);
	bool assign_solution(const vector<double>& row_dec, const vector<double>& col_inc, const vector<double>& col_vertex);
...
private:
	...
	vector<vector<double> > m_assignment;
